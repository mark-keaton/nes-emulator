...
lazy_static! {
        ...
        OpCode::new(0x4A, "LSR", 2, 2, AddressingMode::Accumulator),
        ...
        OpCode::new(0x2A, "ROL", 2, 2, AddressingMode::Accumulator),
        OpCode::new(0x26, "ROL", 2, 3, AddressingMode::ZeroPage),
        OpCode::new(0x36, "ROL", 2, 4, AddressingMode::ZeroPage_X),
